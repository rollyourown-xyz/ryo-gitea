...
This is a [rollyourown project](https://rollyourown.xyz/rollyourown/projects/) to deploy a Gitea git server using Ansible, Packer and Terraform.

## Project Summary

This project uses [Ansible](https://www.ansible.com/), [Packer](https://www.packer.io/) and [Terraform](https://www.terraform.io/) to deploy a [Gitea](https://gitea.io/) server, with a [MariaDB](https://mariadb.org/) backend database, [HAProxy](https://www.haproxy.org/) for TLS/SSL termination and [Certbot](https://certbot.eff.org/) for managing your [Let's Encrypt](https://letsencrypt.org/) certificate.
...
- Issues on Codeberg: [here](https://codeberg.org/rollyourown-xyz/ryo-gitea/issues)
- Issues on GitHub: [here](https://github.com/rollyourown-xyz/ryo-gitea/issues)
...
- [https://codeberg.org/rollyourown-xyz/ryo-gitea](https://codeberg.org/rollyourown-xyz/ryo-gitea)
- [https://github.com/rollyourown-xyz/ryo-gitea](https://github.com/rollyourown-xyz/ryo-gitea)

Our preferred collaboration space is Codeberg:

<a href="https://codeberg.org/rollyourown-xyz/ryo-gitea"><img alt="Get it on Codeberg" src="https://get-it-on.codeberg.org/get-it-on-blue-on-white.png" height="60"></a>

The primary repository for this project is hosted on our own Git repository server at:

- [https://git.rollyourown.xyz/ryo-projects/ryo-gitea](https://git.rollyourown.xyz/ryo-projects/ryo-gitea)
